...
def create_user(email='user@example.com', passowrd='1234pass'):
    """Test create and return user model."""
...
class PrivateIngredientsAPITests(TestCase):
    ...
    def test_ingredients_limited_to_user(self):
        """Test retreiving ingredients of specific user."""
        user_2 = create_user(email='example2@gmai.com', passowrd='pass24747')
        Ingredient.objects.create(user=user_2, name='Ingredient1')
