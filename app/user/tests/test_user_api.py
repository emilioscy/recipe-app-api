...
class PublicUserAPITests(TestCase):
    ...
    def test_password_too_short_error(self):
        """Test error returned when password less than 5 chars."""
        payload = {
            'email': 'test@example.com',
            'password': '123',
            'name': 'Test Name'
    ...
    def test_create_token_bad_credentials(self):
        ...
        create_user(email='testemail@example.com', password='goodpass')
    ...
    def test_create_token_blank_password(self):
        """Test returns error when posting blank password"""
        payload = {'email': 'testemail@example', 'password': ''}
